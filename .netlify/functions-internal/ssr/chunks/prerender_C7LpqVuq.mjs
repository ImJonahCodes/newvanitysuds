/* empty css                         */
import { d as createAstro, e as createComponent, r as renderTemplate, u as unescapeHTML, g as addAttribute, h as renderComponent, i as Fragment, m as maybeRenderHead, j as renderScript, k as renderSlot, l as renderHead, A as AstroError, n as UnknownContentCollectionError, o as renderUniqueStylesheet, p as renderScriptElement, q as createHeadAndContent, t as defineStyleVars, s as spreadAttributes } from './astro_ujMWuv_C.mjs';
import 'kleur/colors';
import { p as prependForwardSlash } from './astro/assets-service_BCnjW2_Z.mjs';
import { g as getImage, $ as $$Image } from './pages/generic_DWdldJRw.mjs';
...
const faviconSrc$1 = new Proxy({"src":"/_astro/logo-1.BPyY9PrM.png","width":2000,"height":2000,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/logos/logo-1.png";
							}
...
const faviconSvgSrc = new Proxy({"src":"/_astro/logo.CjKOsViQ.svg","width":2000,"height":2000,"format":"svg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/logos/logo.svg";
							}
...
var _a$6;
const $$Astro$1l = createAstro("https://vanitysuds.com");
...
const Icons$1 = {
  ...
  question: {
    ...
    class: "mt-1.5 h-6 w-6 flex-shrink-0 text-primary",
    viewBox: "0 0 24 24",
    fill: "none",
    strokeWidth: "1.5",
    strokeLinecap: "round",
...
const $$Astro$1j = createAstro("https://vanitysuds.com");
...
const $$PrimaryCTA = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const bgColorClasses = "bg-primary hover:bg-[#1c75f2] active:bg-[#1c75f2] dark:focus:outline-none";
...
}, "/workspaces/newvanitysuds/src/components/ui/buttons/PrimaryCTA.astro", void 0);

var __freeze$5 = Object.freeze;
var __defProp$5 = Object.defineProperty;
var __template$5 = (cooked, raw) => __freeze$5(__defProp$5(cooked, "raw", { value: __freeze$5(raw || cooked.slice()) }));
var _a$5;
const $$Astro$1h = createAstro("https://vanitysuds.com");
const $$Navbar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a$5 || (_a$5 = __template$5(["<!-- Main header component -->", '<header class="sticky inset-x-0 top-4 z-50 flex w-full flex-wrap text-sm md:flex-nowrap md:justify-start"> <!-- Navigation container --> <nav class="relative mx-2 w-full rounded-[36px] border border-yellow-100/40 bg-yellow-50/60 px-4 py-3 backdrop-blur-md dark:border-neutral-700/40 dark:bg-neutral-950/80 dark:backdrop-blur-md md:flex md:items-center md:justify-between md:px-6 md:py-0 lg:px-8 xl:mx-auto" aria-label="Global"> <div class="flex items-center justify-between"> <!-- Brand logo --> <a class="flex-none text-primary rounded-lg text-xl font-bold outline-none ring-zinc-500 focus-visible:ring dark:ring-zinc-200 dark:focus:outline-none"', ' aria-label="Brand">\nVANITY SUDS\n</a> <!-- Collapse toggle for smaller screens --> <div class="ml-auto mr-5 md:hidden"> <button type="button" class="hs-collapse-toggle flex h-8 w-8 items-center justify-center rounded-full text-sm font-bold text-neutral-600 transition duration-300 hover:bg-neutral-200 disabled:pointer-events-none disabled:opacity-50 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:outline-none" data-hs-collapse="#navbar-collapse-with-animation" aria-controls="navbar-collapse-with-animation" aria-label="Toggle navigation"> <svg class="h-[1.25rem] w-[1.25rem] flex-shrink-0 hs-collapse-open:hidden" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"> <line x1="3" x2="21" y1="6" y2="6"></line> <line x1="3" x2="21" y1="12" y2="12"></line> <line x1="3" x2="21" y1="18" y2="18"></line> </svg> <svg class="hidden h-[1.25rem] w-[1.25rem] flex-shrink-0 hs-collapse-open:block" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"> <path d="M18 6 6 18"></path> <path d="m6 6 12 12"></path> </svg> </button> </div> </div> <!-- Contains navigation links --> <div id="navbar-collapse-with-animation" class="hs-collapse hidden grow basis-full overflow-hidden transition-all duration-300 md:block"> <!-- Navigation links container --> <div class="mt-5 flex flex-col gap-x-0 gap-y-4 md:mt-0 md:flex-row md:items-center md:justify-end md:gap-x-4 lg:gap-x-7 md:gap-y-0 md:ps-7"> <!-- Navigation links and Authentication component --> ', ' <div class="pt-5 pb-5"> ', ' </div> </div> </div> </nav> </header> <!-- Theme Appearance script to manage light/dark modes --> <script>\n  const HSThemeAppearance = {\n    init() {\n      const defaultTheme = "default";\n      let theme = localStorage.getItem("hs_theme") || defaultTheme;\n\n      if (document.querySelector("html").classList.contains("dark")) return;\n      this.setAppearance(theme);\n    },\n    _resetStylesOnLoad() {\n      const $resetStyles = document.createElement("style");\n      $resetStyles.innerText = `*{transition: unset !important;}`;\n      $resetStyles.setAttribute("data-hs-appearance-onload-styles", "");\n      document.head.appendChild($resetStyles);\n      return $resetStyles;\n    },\n    setAppearance(theme, saveInStore = true, dispatchEvent = true) {\n      const $resetStylesEl = this._resetStylesOnLoad();\n\n      if (saveInStore) {\n        localStorage.setItem("hs_theme", theme);\n      }\n\n      if (theme === "auto") {\n        theme = window.matchMedia("(prefers-color-scheme: dark)").matches\n          ? "dark"\n          : "default";\n      }\n\n      document.querySelector("html").classList.remove("dark");\n      document.querySelector("html").classList.remove("default");\n      document.querySelector("html").classList.remove("auto");\n\n      document\n        .querySelector("html")\n        .classList.add(this.getOriginalAppearance());\n\n      setTimeout(() => {\n        $resetStylesEl.remove();\n      });\n\n      if (dispatchEvent) {\n        window.dispatchEvent(\n          new CustomEvent("on-hs-appearance-change", { detail: theme }),\n        );\n      }\n    },\n    getAppearance() {\n      let theme = this.getOriginalAppearance();\n      if (theme === "auto") {\n        theme = window.matchMedia("(prefers-color-scheme: dark)").matches\n          ? "dark"\n          : "default";\n      }\n      return theme;\n    },\n    getOriginalAppearance() {\n      const defaultTheme = "default";\n      return localStorage.getItem("hs_theme") || defaultTheme;\n    },\n  };\n  HSThemeAppearance.init();\n\n  window\n    .matchMedia("(prefers-color-scheme: dark)")\n    .addEventListener("change", () => {\n      if (HSThemeAppearance.getOriginalAppearance() === "auto") {\n        HSThemeAppearance.setAppearance("auto", false);\n      }\n    });\n\n  window.addEventListener("load", () => {\n    const $clickableThemes = document.querySelectorAll(\n      "[data-hs-theme-click-value]",\n    );\n    const $switchableThemes = document.querySelectorAll(\n      "[data-hs-theme-switch]",\n    );\n\n    $clickableThemes.forEach(($item) => {\n      $item.addEventListener("click", () =>\n        HSThemeAppearance.setAppearance(\n          $item.getAttribute("data-hs-theme-click-value"),\n          true,\n          $item,\n        ),\n      );\n    });\n\n    $switchableThemes.forEach(($item) => {\n      $item.addEventListener("change", (e) => {\n        HSThemeAppearance.setAppearance(e.target.checked ? "dark" : "default");\n      });\n\n      $item.checked = HSThemeAppearance.getAppearance() === "dark";\n    });\n\n    window.addEventListener("on-hs-appearance-change", (e) => {\n      $switchableThemes.forEach(($item) => {\n        $item.checked = e.detail === "dark";\n      });\n    });\n  });\n<\/script> <!--Import the necessary Collapse and Overlay plugins--> <!--https://preline.co/plugins/html/collapse.html--> <!--https://preline.co/plugins/html/overlay.html--> <script src="/scripts/vendor/preline/collapse/index.js"><\/script> <script src="/scripts/vendor/preline/overlay/index.js"><\/script>'], ["<!-- Main header component -->", '<header class="sticky inset-x-0 top-4 z-50 flex w-full flex-wrap text-sm md:flex-nowrap md:justify-start"> <!-- Navigation container --> <nav class="relative mx-2 w-full rounded-[36px] border border-yellow-100/40 bg-yellow-50/60 px-4 py-3 backdrop-blur-md dark:border-neutral-700/40 dark:bg-neutral-950/80 dark:backdrop-blur-md md:flex md:items-center md:justify-between md:px-6 md:py-0 lg:px-8 xl:mx-auto" aria-label="Global"> <div class="flex items-center justify-between"> <!-- Brand logo --> <a class="flex-none text-primary rounded-lg text-xl font-bold outline-none ring-zinc-500 focus-visible:ring dark:ring-zinc-200 dark:focus:outline-none"', ' aria-label="Brand">\nVANITY SUDS\n</a> <!-- Collapse toggle for smaller screens --> <div class="ml-auto mr-5 md:hidden"> <button type="button" class="hs-collapse-toggle flex h-8 w-8 items-center justify-center rounded-full text-sm font-bold text-neutral-600 transition duration-300 hover:bg-neutral-200 disabled:pointer-events-none disabled:opacity-50 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:outline-none" data-hs-collapse="#navbar-collapse-with-animation" aria-controls="navbar-collapse-with-animation" aria-label="Toggle navigation"> <svg class="h-[1.25rem] w-[1.25rem] flex-shrink-0 hs-collapse-open:hidden" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"> <line x1="3" x2="21" y1="6" y2="6"></line> <line x1="3" x2="21" y1="12" y2="12"></line> <line x1="3" x2="21" y1="18" y2="18"></line> </svg> <svg class="hidden h-[1.25rem] w-[1.25rem] flex-shrink-0 hs-collapse-open:block" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"> <path d="M18 6 6 18"></path> <path d="m6 6 12 12"></path> </svg> </button> </div> </div> <!-- Contains navigation links --> <div id="navbar-collapse-with-animation" class="hs-collapse hidden grow basis-full overflow-hidden transition-all duration-300 md:block"> <!-- Navigation links container --> <div class="mt-5 flex flex-col gap-x-0 gap-y-4 md:mt-0 md:flex-row md:items-center md:justify-end md:gap-x-4 lg:gap-x-7 md:gap-y-0 md:ps-7"> <!-- Navigation links and Authentication component --> ', ' <div class="pt-5 pb-5"> ', ' </div> </div> </div> </nav> </header> <!-- Theme Appearance script to manage light/dark modes --> <script>\n  const HSThemeAppearance = {\n    init() {\n      const defaultTheme = "default";\n      let theme = localStorage.getItem("hs_theme") || defaultTheme;\n\n      if (document.querySelector("html").classList.contains("dark")) return;\n      this.setAppearance(theme);\n    },\n    _resetStylesOnLoad() {\n      const $resetStyles = document.createElement("style");\n      $resetStyles.innerText = \\`*{transition: unset !important;}\\`;\n      $resetStyles.setAttribute("data-hs-appearance-onload-styles", "");\n      document.head.appendChild($resetStyles);\n      return $resetStyles;\n    },\n    setAppearance(theme, saveInStore = true, dispatchEvent = true) {\n      const $resetStylesEl = this._resetStylesOnLoad();\n\n      if (saveInStore) {\n        localStorage.setItem("hs_theme", theme);\n      }\n\n      if (theme === "auto") {\n        theme = window.matchMedia("(prefers-color-scheme: dark)").matches\n          ? "dark"\n          : "default";\n      }\n\n      document.querySelector("html").classList.remove("dark");\n      document.querySelector("html").classList.remove("default");\n      document.querySelector("html").classList.remove("auto");\n\n      document\n        .querySelector("html")\n        .classList.add(this.getOriginalAppearance());\n\n      setTimeout(() => {\n        $resetStylesEl.remove();\n      });\n\n      if (dispatchEvent) {\n        window.dispatchEvent(\n          new CustomEvent("on-hs-appearance-change", { detail: theme }),\n        );\n      }\n    },\n    getAppearance() {\n      let theme = this.getOriginalAppearance();\n      if (theme === "auto") {\n        theme = window.matchMedia("(prefers-color-scheme: dark)").matches\n          ? "dark"\n          : "default";\n      }\n      return theme;\n    },\n    getOriginalAppearance() {\n      const defaultTheme = "default";\n      return localStorage.getItem("hs_theme") || defaultTheme;\n    },\n  };\n  HSThemeAppearance.init();\n\n  window\n    .matchMedia("(prefers-color-scheme: dark)")\n    .addEventListener("change", () => {\n      if (HSThemeAppearance.getOriginalAppearance() === "auto") {\n        HSThemeAppearance.setAppearance("auto", false);\n      }\n    });\n\n  window.addEventListener("load", () => {\n    const $clickableThemes = document.querySelectorAll(\n      "[data-hs-theme-click-value]",\n    );\n    const $switchableThemes = document.querySelectorAll(\n      "[data-hs-theme-switch]",\n    );\n\n    $clickableThemes.forEach(($item) => {\n      $item.addEventListener("click", () =>\n        HSThemeAppearance.setAppearance(\n          $item.getAttribute("data-hs-theme-click-value"),\n          true,\n          $item,\n        ),\n      );\n    });\n\n    $switchableThemes.forEach(($item) => {\n      $item.addEventListener("change", (e) => {\n        HSThemeAppearance.setAppearance(e.target.checked ? "dark" : "default");\n      });\n\n      $item.checked = HSThemeAppearance.getAppearance() === "dark";\n    });\n\n    window.addEventListener("on-hs-appearance-change", (e) => {\n      $switchableThemes.forEach(($item) => {\n        $item.checked = e.detail === "dark";\n      });\n    });\n  });\n<\/script> <!--Import the necessary Collapse and Overlay plugins--> <!--https://preline.co/plugins/html/collapse.html--> <!--https://preline.co/plugins/html/overlay.html--> <script src="/scripts/vendor/preline/collapse/index.js"><\/script> <script src="/scripts/vendor/preline/overlay/index.js"><\/script>'])), maybeRenderHead(), addAttribute(homeUrl, "href"), strings.navBarLinks.map((link) => renderTemplate`${renderComponent($$result, "NavLink", $$NavLink, { "url": link.url, "name": link.name })}`), renderComponent($$result, "PrimaryCTA", $$PrimaryCTA, { "title": "Book Appointment", "url": "/book" }));
}, "/workspaces/newvanitysuds/src/components/sections/Navbar.astro", void 0);

const $$Astro$1g = createAstro("https://vanitysuds.com");
const $$Deal = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1g, $$props, $$slots);
  Astro2.self = $$Deal;
  return renderTemplate`${maybeRenderHead()}<div x-data="{ isOpen: true }" class="fixed bottom-0 end-0 z-[60] sm:max-w-sm w-full mx-auto p-6" x-show="isOpen"> <!-- Card --> <div class="p-4 bg-white/[.6] backdrop-blur-lg rounded-xl shadow-2xl dark:bg-slate-900/[.6] dark:shadow-black/[.7]"> <div class="flex justify-between items-center gap-x-5 sm:gap-x-10"> <h2 class="font-semibold text-gray-800 dark:text-white">
SPRING DEAL
</h2> <button @click="isOpen = false" type="button" class="inline-flex rounded-full p-2 text-gray-500 hover:bg-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-600 dark:hover:bg-gray-800 dark:text-gray-300"> <span class="sr-only">Dismiss</span> <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"></path><path d="m6 6 12 12"></path></svg> </button> </div> <p class="mt-2 text-sm text-gray-800 dark:text-gray-200">
Get ready to blossom this spring with our unbeatable spring deal - let us revive your vehicle's shine, so you can hit the road in style!
</p> <div class="mt-5 mb-2 w-full flex gap-x-2 text-center"> <button type="button" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-primary dark:text-white dark:hover:bg-gray-800">
Use Code
<span class="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-lg text-xs font-medium bg-blue-100 text-primary dark:bg-blue-800/30 dark:text-primary">SPRING</span>
For 15% Off!
</button> </div> <div class="grid w-full"> <div class="flex justify-center items-center w-full"> <a type="button" href="/book" class="w-full py-2 px-3 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">
BOOK NOW
</a> </div> </div> </div> <!-- End Card --> </div>`;
}, "/workspaces/newvanitysuds/src/components/banners/deal.astro", void 0);

var __freeze$4 = Object.freeze;
var __defProp$4 = Object.defineProperty;
var __template$4 = (cooked, raw) => __freeze$4(__defProp$4(cooked, "raw", { value: __freeze$4(raw || cooked.slice()) }));
var _a$4;
const $$Astro$1f = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/ui/buttons/Btn404.astro", void 0);

const $$Astro$1d = createAstro("https://vanitysuds.com");
const $$404 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": pageTitle }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="grid h-svh place-content-center"> <div class="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16"> <div class="mx-auto max-w-screen-sm text-center"> <h1 class="text-dark mb-4 text-7xl font-extrabold text-yellow-500 dark:text-yellow-400 lg:text-9xl"> ${title} </h1> <p class="mb-4 text-balance text-3xl font-bold tracking-tight text-neutral-700 dark:text-neutral-300 md:text-4xl"> ${subTitle} </p> <p class="mb-4 text-pretty text-lg text-neutral-600 dark:text-neutral-400"> ${content} </p> <!--Display a button that navigates user back to the previous page--> ${renderComponent($$result2, "Btn404", $$Btn404, { "title": btnTitle, "id": "go-back" })} </div> </div> </section> ` })} <!--JavaScript code that adds click event to the Button, resulting in going back to the previous page in history--> ${renderScript($$result, "/workspaces/newvanitysuds/src/pages/404.astro?astro&type=script&index=0&lang.ts")}`;
}, "/workspaces/newvanitysuds/src/pages/404.astro", void 0);

const $$file$a = "/workspaces/newvanitysuds/src/pages/404.astro";
const $$url$a = "/404";
...
const cosmic = createBucketClient({
  bucketSlug: "vanity-suds-production",
  readKey: "OjedP4f8B6oHz4Wy08dzX5eTL3gv27GcXJCUdtpqRGdhWYlEXc"
});
...
const $$Astro$1c = createAstro("https://vanitysuds.com");
...
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": post.title, "structuredData": {
    "@context": "https://schema.org",
    "@type": "WebPage",
    "@id": "https://vanitysuds.com/blog",
    "url": "https://vanitysuds.com/blog",
    "name": "Blog | Vanity Suds",
    ...
    "inLanguage": "en-US"
  } }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="mx-auto max-w-3xl px-4 pb-12 pt-6 sm:px-6 lg:px-8 lg:pt-10"> <div class="max-w-2xl"> <div class="mb-6 flex items-center justify-between"> <div class="flex w-full gap-x-5 sm:items-center sm:gap-x-3"> <div class="grow"> <div class="flex items-center justify-between gap-x-2"> <div> <div class="hs-tooltip inline-block [--placement:bottom] [--trigger:hover]"> <!--Post metadata and author info--> <span class="font-bold text-neutral-700 dark:text-neutral-300"> ${post.metadata.author.title} </span> </div> <ul class="text-xs text-neutral-500"> <li class="relative inline-block pe-6 before:absolute before:end-2 before:top-1/2 before:size-1 before:-translate-y-1/2 before:rounded-full before:bg-neutral-300 last:pe-0 last-of-type:before:hidden dark:text-neutral-400 dark:before:bg-neutral-600"> ${formatDate(post.metadata.published_date)} </li> </ul> </div> </div> </div> </div> </div> <!--Blog post title--> <h2 class="mb-3 text-2xl font-bold text-neutral-800 dark:text-primary md:text-3xl"> ${post.title} </h2> <!--Blog post contents--> <div class="mb-5 space-y-5 md:mb-8 md:space-y-8"> <p class="text-pretty text-lg text-neutral-700 dark:text-neutral-300"> ${post.metadata.excerpt} </p> ${renderComponent($$result2, "Image", $$Image, { "class": "w-full rounded-xl object-cover", "src": post.metadata.image.imgix_url, "alt": post.metadata.image.imgix_url, "draggable": "false", "format": "avif", "inferSize": true })} <div class="text-pretty mx-auto prose prose-xl dark:prose-invert prose-h3:pt-6 prose-h3:pb-4 prose-h3:text-primary"> <div>${unescapeHTML(marked.parse(`${post.metadata.content}`))}</div> </div> </div> <div class="mx-auto grid max-w-screen-lg gap-y-5 sm:flex sm:items-center sm:justify-between sm:gap-y-0"></div> </div> </section> ` })}`;
}, "/workspaces/newvanitysuds/src/pages/blog/[slug].astro", void 0);

const $$file$9 = "/workspaces/newvanitysuds/src/pages/blog/[slug].astro";
const $$url$9 = "/blog/[slug]";
...
const $$Astro$1b = createAstro("https://vanitysuds.com");
const $$CardBlog = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { href, title, excerpt, tags, author, postDate, postImage, authorImage } = Astro2.props;
  return renderTemplate`<!-- The following anchor tag is the main container for the card.
     ...
     which automatically prefetches the linked page to speed up navigation. -->${maybeRenderHead()}<a class="group relative block rounded-xl outline-none ring-zinc-500 transition duration-500 focus-visible:ring dark:ring-zinc-200 dark:focus:outline-none"${addAttribute(`/blog/${href}/`, "href")} data-astro-prefetch> <!-- The container for the blog post's cover image. Uses astro:assets' Image for image source --> <div class="relative h-[350px] w-full flex-shrink-0 overflow-hidden rounded-xl before:absolute before:inset-x-0 before:z-[1] before:size-full before:bg-gradient-to-t before:from-neutral-900/[.7]"> ${renderComponent($$result, "Image", $$Image, { "class": "absolute start-0 top-0 size-full object-cover transition duration-500 group-hover:scale-110", "src": postImage, "alt": "test", "draggable": "false", "loading": "eager", "format": "avif", "inferSize": true })} <div class="absolute top-0 left-0 w-full h-full bg-black opacity-50"></div> </div> <!-- The container for the blog author's avatar and associated metadata (author name and publication date) --> <div class="absolute inset-x-0 top-0 z-10"> <div class="flex h-full flex-col p-4 sm:p-6"> <div class="flex items-center"> <div class="ms-2.5 sm:ms-4"> <h4 class="font-bold text-neutral-50"> ${author} </h4> <p class="text-md text-neutral-50"> ${formatDate(postDate)} </p> </div> </div> </div> </div> <!-- The container for the blog post's title and description --> <div class="absolute inset-x-0 bottom-0 z-10"> <div class="flex h-full flex-col p-4 sm:p-6"> <h3 class="text-balance text-lg font-bold text-neutral-50 group-hover:text-neutral-50/[.8] sm:text-3xl"> ${title} </h3> <p class="mt-2 text-pretty text-neutral-50/[.8]"> ${excerpt} </p> </div> </div> </a>`;
}, "/workspaces/newvanitysuds/src/components/ui/cards/CardBlog.astro", void 0);

const $$Astro$1a = createAstro("https://vanitysuds.com");
const $$Index$3 = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1a, $$props, $$slots);
  Astro2.self = $$Index$3;
  const data = await getAllPosts();
  const title = "Your Gateway to Detailing Excellence";
  const subTitle = "Explore the latest news, tips, and insights from Vanity Suds to enhance your vehicles appearence. From detailing knowledge to news updates, our blog is your go-to resource for all things detailing.";
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": pageTitle, "structuredData": {
    ...
    "inLanguage": "en-US"
  } }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="mx-auto max-w-[85rem] space-y-8 px-4 pt-16 sm:px-6 lg:px-8 2xl:max-w-full"> <!--Page header--> <div class="mx-auto max-w-3xl text-left sm:text-center"> <h1 class="block text-balance text-4xl font-bold tracking-tight text-neutral-800 dark:text-neutral-200 md:text-5xl lg:text-6xl"> ${title} </h1> <p class="mt-4 text-pretty text-lg text-neutral-600 dark:text-neutral-400"> ${subTitle} </p> </div> </section> <section class="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 2xl:max-w-full"> <!--Blog posts grid--> <div class="grid gap-6 lg:grid-cols-2"> ${data.map((post) => renderTemplate`${renderComponent($$result2, "CardBlog", $$CardBlog, { "title": post.title, "href": post.slug, "excerpt": post.metadata.excerpt, "author": post.metadata.author.title, "postDate": post.metadata.published_date, "postImage": post.metadata.image.imgix_url })}`)} </div> </section> ` })}`;
}, "/workspaces/newvanitysuds/src/pages/blog/index.astro", void 0);

const $$file$8 = "/workspaces/newvanitysuds/src/pages/blog/index.astro";
const $$url$8 = "/blog";
...
const $$Astro$19 = createAstro("https://vanitysuds.com");
const $$Hero$1 = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$19, $$props, $$slots);
  Astro2.self = $$Hero$1;
  return renderTemplate`<!-- Defining a grid container that holds all the content -->${maybeRenderHead()}<section class="mx-auto h-full w-full gap-4 px-4 py-14 sm:px-6 md:items-center md:gap-8 lg:px-8 2xl:max-w-full"> <iframe id="myIframe" src="https://app.urable.com/virtual-shop/FyMeQRTSA0XU11LDiEBQ" style="width: 100%; border: none;"></iframe> </section> ${renderScript($$result, "/workspaces/newvanitysuds/src/components/sections/book/hero.astro?astro&type=script&index=0&lang.ts")}`;
}, "/workspaces/newvanitysuds/src/components/sections/book/hero.astro", void 0);

const $$Astro$18 = createAstro("https://vanitysuds.com");
const $$Book = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$18, $$props, $$slots);
  Astro2.self = $$Book;
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, {}, { "default": ($$result2) => renderTemplate`  ${renderComponent($$result2, "HeroSection", $$Hero$1, {})} ` })}`;
}, "/workspaces/newvanitysuds/src/pages/book.astro", void 0);

const $$file$7 = "/workspaces/newvanitysuds/src/pages/book.astro";
const $$url$7 = "/book";

const book = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
	__proto__: null,
	default: $$Book,
	file: $$file$7,
	url: $$url$7
...
const $$Astro$17 = createAstro("https://vanitysuds.com");
const $$AuthBtn = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const borderClasses = "border border-transparent";
  const bgColorClasses = "bg-primary dark:focus:outline-none";
  const hoverClasses = "hover:bg-primary/50";
  const fontSizeClasses = "2xl:text-base";
...
}, "/workspaces/newvanitysuds/src/components/ui/buttons/AuthBtn.astro", void 0);

const $$Astro$16 = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/ui/blocks/ContactIconBlock.astro", void 0);

const $$Astro$15 = createAstro("https://vanitysuds.com");
const $$TextInput = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div> <label${addAttribute(id, "for")} class="sr-only">${label}</label> <input type="text"${addAttribute(name, "name")}${addAttribute(id, "id")} class="block w-full rounded-lg border border-primary bg-neutral-50 px-4 py-3 text-sm text-neutral-700 placeholder:text-neutral-500 focus:border-neutral-200 focus:outline-none focus:ring focus:ring-neutral-400 disabled:pointer-events-none disabled:opacity-50 dark:border-primary dark:bg-neutral-700/30 dark:text-neutral-300 dark:placeholder:text-neutral-400 dark:focus:ring-1"${addAttribute(label, "placeholder")}> </div>`;
}, "/workspaces/newvanitysuds/src/components/ui/forms/input/TextInput.astro", void 0);

const $$Astro$14 = createAstro("https://vanitysuds.com");
const $$EmailContactInput = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<!-- Container for the label and email input field -->${maybeRenderHead()}<div> <!-- Label for the email input field, visually hidden but accessible to screen readers --> <label${addAttribute(id, "for")} class="sr-only">${label}</label> <!-- Email input field --> <input type="email" name="email"${addAttribute(id, "id")} autocomplete="email" class="block w-full rounded-lg border border-primary bg-neutral-50 px-4 py-3 text-sm text-neutral-700 placeholder:text-neutral-500 focus:border-neutral-200 focus:outline-none focus:ring focus:ring-neutral-400 disabled:pointer-events-none disabled:opacity-50 dark:border-primary dark:bg-neutral-700/30 dark:text-neutral-300 dark:placeholder:text-neutral-400 dark:focus:ring-1" placeholder="Email"> </div>`;
}, "/workspaces/newvanitysuds/src/components/ui/forms/input/EmailContactInput.astro", void 0);

const $$Astro$13 = createAstro("https://vanitysuds.com");
const $$PhoneInput = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div> <label${addAttribute(id, "for")} class="sr-only">${label}</label> <input type="tel" name="phoneNumber"${addAttribute(id, "id")} class="block w-full rounded-lg border border-primary bg-neutral-50 px-4 py-3 text-sm text-neutral-700 placeholder:text-neutral-500 focus:border-neutral-200 focus:outline-none focus:ring focus:ring-neutral-400 disabled:pointer-events-none disabled:opacity-50 dark:border-primary dark:bg-neutral-700/30 dark:text-neutral-300 dark:placeholder:text-neutral-400 dark:focus:ring-1"${addAttribute(label, "placeholder")}> </div>`;
}, "/workspaces/newvanitysuds/src/components/ui/forms/input/PhoneInput.astro", void 0);

const $$Astro$12 = createAstro("https://vanitysuds.com");
const $$TextAreaInput = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { label, id, name } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div> <label${addAttribute(id, "for")} class="sr-only">${label}</label> <textarea${addAttribute(id, "id")}${addAttribute(name, "name")} rows="4" class="block w-full rounded-lg border border-primary bg-neutral-50 px-4 py-3 text-sm text-neutral-700 placeholder:text-neutral-500 focus:border-neutral-200 focus:outline-none focus:ring focus:ring-neutral-400 disabled:pointer-events-none disabled:opacity-50 dark:border-primary dark:bg-neutral-700/30 dark:text-neutral-300 dark:placeholder:text-neutral-400 dark:focus:ring-1"${addAttribute(label, "placeholder")}></textarea> </div>`;
}, "/workspaces/newvanitysuds/src/components/ui/forms/input/TextAreaInput.astro", void 0);

const $$Astro$11 = createAstro("https://vanitysuds.com");
const $$ContactSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const subTitle = "Have questions or want to discuss a booking/service? Reach out and let's craft the perfect solution for your vehicle!";
  const formTitle = "Fill in the form below";
  const formSubTitle = "We'll get back to you in 1-2 business days.";
  return renderTemplate`<!-- Contact Us -->${maybeRenderHead()}<section class="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14"> <div class="mx-auto max-w-2xl lg:max-w-5xl"> <div class="text-center"> <h1 class="text-balance text-2xl font-bold tracking-tight text-neutral-800 dark:text-neutral-200 md:text-4xl md:leading-tight"> ${title} </h1> <p class="mt-1 text-pretty text-neutral-600 dark:text-neutral-400"> ${subTitle} </p> </div> <div class="mt-12 grid items-center gap-6 lg:grid-cols-2 lg:gap-16"> <div class="flex flex-col rounded-xl p-4 sm:p-6 lg:p-8"> <h2 class="mb-8 text-xl font-bold text-neutral-700 dark:text-neutral-300"> ${formTitle} </h2> <!-- Form for user input with various input fields.--> <!-- Each field utilizes a different input component for the specific type of input (text, email, phone, and textarea)--> <form id="contactForm" action="https://submit-form.com/3jnshyywd" method="POST"> <div class="grid gap-4"> <div class="grid grid-cols-1 gap-4 sm:grid-cols-2"> ${renderComponent($$result, "TextInput", $$TextInput, { "id": "firstName", "label": "First Name", "name": "firstName" })} ${renderComponent($$result, "TextInput", $$TextInput, { "id": "lastName", "label": "Last Name", "name": "lastName" })} </div> ${renderComponent($$result, "EmailContactInput", $$EmailContactInput, { "id": "email" })} ${renderComponent($$result, "PhoneInput", $$PhoneInput, { "id": "phoneNumber" })} ${renderComponent($$result, "TextAreaInput", $$TextAreaInput, { "id": "details", "label": "Details", "name": "details" })} </div> <input type="hidden" name="_redirect" value="https://vanitysuds.com/contact"> <div id="popup" class="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-50 hidden"> <div class="bg-white rounded-lg p-8"> <p id="popupMessage" class="text-lg text-center mb-4"></p> <button id="closePopup" class="bg-blue-500 text-white px-4 py-2 rounded-md">Close</button> </div> </div> <div class="mt-4 grid"> ${renderComponent($$result, "AuthBtn", $$AuthBtn, { "title": "Send Message" })} </div> <div class="mt-3 text-center"> <p class="text-sm text-neutral-600 dark:text-neutral-400"> ${formSubTitle} </p> </div> </form> </div> <!--ContactIconBlocks are used to display different methods of contacting, including visiting office, email, browsing knowledgebase, and FAQ.--> <div class="divide-y divide-neutral-300 dark:divide-neutral-700"> ${renderComponent($$result, "ContactIconBlock", $$ContactIconBlock, { "heading": "Knowledgebase", "content": "Browse through all of our knowledgebase articles.", "isLinkVisible": true, "linkTitle": "Visit guides & tutorials", "linkURL": "#", "isArrowVisible": true }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon$1, { "name": "question" })} ` })} ${renderComponent($$result, "ContactIconBlock", $$ContactIconBlock, { "heading": "FAQ", "content": "Explore our FAQ for quick, clear answers to common queries.", "isLinkVisible": true, "linkTitle": "Visit FAQ", "linkURL": "#", "isArrowVisible": true }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon$1, { "name": "chatBubble" })} ` })} ${renderComponent($$result, "ContactIconBlock", $$ContactIconBlock, { "heading": "Visit our Instagram", "content": "Our Instagram and Facebook", "isAddressVisible": true, "addressContent": "@vanitysuds" }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon$1, { "name": "instagram" })} ` })} ${renderComponent($$result, "ContactIconBlock", $$ContactIconBlock, { "heading": "Contact us by email", "content": "Prefer the written word? Drop us an email at", "isLinkVisible": true, "linkTitle": "contact@vanitysuds.com", "linkURL": "#" }, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Icon", $$Icon$1, { "name": "envelopeOpen" })} ` })} </div> </div> </div> <!-- Popup container --> <div id="popup" class="fixed top-0 left-0 w-full h-full bg-gray-700 bg-opacity-50 flex justify-center items-center hidden"> <div class="bg-white p-6 rounded-lg shadow-lg"> <p id="popupMessage" class="text-lg"></p> <button id="closePopup" class="mt-4 px-4 py-2 bg-blue-500 text-white rounded-md">Close</button> </div> </div> </section>`;
}, "/workspaces/newvanitysuds/src/components/sections/ContactSection.astro", void 0);

const $$Astro$10 = createAstro("https://vanitysuds.com");
const $$Contact = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<!--Utilizing MainLayout for the outer layout of the page, and defining meta for SEO purposes-->${renderComponent($$result, "MainLayout", $$MainLayout, { "title": pageTitle, "structuredData": {
    "@context": "https://vanitysuds.com",
    "@type": "WebPage",
    "@id": "https://vanitysuds.com/contact",
    "url": "https://vanitysuds.com/contact",
    "name": "Contact Us | Vanity Suds",
    "description": "Have questions or want to discuss a booking/service? Reach out and let's craft the perfect solution for your vehicle!",
    "isPartOf": {
      "@type": "WebSite",
      "url": "https://vanitysuds.com",
      "name": "Vanity Suds Detailing",
      "description": "Vanity Suds offers top-tier mobile detailing services and expert ceramic coating services for your vehicle. Start exploring and contact our team for superior quality and reliability."
    },
    "inLanguage": "en-US"
  } }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "ContactSection", $$ContactSection, {})} ` })}`;
}, "/workspaces/newvanitysuds/src/pages/contact.astro", void 0);

const $$file$6 = "/workspaces/newvanitysuds/src/pages/contact.astro";
const $$url$6 = "/contact";
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    let entries = [];
    if (!Object.assign({"PUBLIC_COSMIC_BUCKET_SLUG": "vanity-suds-production", "PUBLIC_COSMIC_READ_KEY": "OjedP4f8B6oHz4Wy08dzX5eTL3gv27GcXJCUdtpqRGdhWYlEXc", "BASE_URL": "/", "MODE": "production", "DEV": false, "PROD": true, "SSR": true, "SITE": "https://vanitysuds.com", "ASSETS_PREFIX": undefined}, { _: process.env._ })?.DEV && cacheEntriesByCollection.has(collection)) {
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/post-1.md": () => import('./post-1_CJOEtTYR.mjs'),"/src/content/blog/post-2.md": () => import('./post-2_BKXZGHQs.mjs'),"/src/content/blog/post-3.md": () => import('./post-3_Cz8RmQNj.mjs'),"/src/content/docs/advanced/technical-specifications.mdx": () => import('./technical-specifications_BDLtSvxi.mjs'),"/src/content/docs/construction/custom-solutions.mdx": () => import('./custom-solutions_D018Hdhh.mjs'),"/src/content/docs/construction/project-planning.mdx": () => import('./project-planning_DoXdpVE4.mjs'),"/src/content/docs/construction/safety.mdx": () => import('./safety_DYlEOqp2.mjs'),"/src/content/docs/construction/service-overview.mdx": () => import('./service-overview_D8gMpD-G.mjs'),"/src/content/docs/de/guides/first-project-checklist.mdx": () => import('./first-project-checklist_BgRmLQxV.mjs'),"/src/content/docs/de/guides/getting-started.mdx": () => import('./getting-started_BhxzYmTp.mjs'),"/src/content/docs/de/guides/intro.mdx": () => import('./intro_DNdD3l-2.mjs'),"/src/content/docs/de/welcome-to-docs.mdx": () => import('./welcome-to-docs_B5RO0u-3.mjs'),"/src/content/docs/es/guides/first-project-checklist.mdx": () => import('./first-project-checklist_yK54OBJr.mjs'),"/src/content/docs/es/guides/getting-started.mdx": () => import('./getting-started_Cxc2s84N.mjs'),"/src/content/docs/es/guides/intro.mdx": () => import('./intro_DUW-K4_W.mjs'),"/src/content/docs/es/welcome-to-docs.mdx": () => import('./welcome-to-docs_CXblHlbL.mjs'),"/src/content/docs/fa/guides/first-project-checklist.mdx": () => import('./first-project-checklist_Bb6vsn9F.mjs'),"/src/content/docs/fa/guides/getting-started.mdx": () => import('./getting-started_CMyt-_em.mjs'),"/src/content/docs/fa/guides/intro.mdx": () => import('./intro_CRr0uGMI.mjs'),"/src/content/docs/fa/welcome-to-docs.mdx": () => import('./welcome-to-docs_Dx34F0IK.mjs'),"/src/content/docs/fr/guides/first-project-checklist.mdx": () => import('./first-project-checklist_y4MT4baF.mjs'),"/src/content/docs/fr/guides/getting-started.mdx": () => import('./getting-started_C379SEMR.mjs'),"/src/content/docs/fr/guides/intro.mdx": () => import('./intro_3DPRHPSM.mjs'),"/src/content/docs/fr/welcome-to-docs.mdx": () => import('./welcome-to-docs_DTUZ57qu.mjs'),"/src/content/docs/guides/first-project-checklist.mdx": () => import('./first-project-checklist_BpZSP0WB.mjs'),"/src/content/docs/guides/getting-started.mdx": () => import('./getting-started_CCmCpH93.mjs'),"/src/content/docs/guides/intro.mdx": () => import('./intro_CEkQ-4ui.mjs'),"/src/content/docs/ja/guides/first-project-checklist.mdx": () => import('./first-project-checklist_BmWxSyIF.mjs'),"/src/content/docs/ja/guides/getting-started.mdx": () => import('./getting-started_BPSl_ZUt.mjs'),"/src/content/docs/ja/guides/intro.mdx": () => import('./intro_B1I8Dq9g.mjs'),"/src/content/docs/ja/welcome-to-docs.mdx": () => import('./welcome-to-docs_DCGwzfue.mjs'),"/src/content/docs/tools/equipment-care.mdx": () => import('./equipment-care_Bm5NGZqx.mjs'),"/src/content/docs/tools/tool-guides.mdx": () => import('./tool-guides_qBCWfsm4.mjs'),"/src/content/docs/welcome-to-docs.mdx": () => import('./welcome-to-docs_DnJ0LAy8.mjs'),"/src/content/docs/zh-cn/guides/first-project-checklist.mdx": () => import('./first-project-checklist_r9EkWO0K.mjs'),"/src/content/docs/zh-cn/guides/getting-started.mdx": () => import('./getting-started_BFZtJihh.mjs'),"/src/content/docs/zh-cn/guides/intro.mdx": () => import('./intro_BF0DfPRJ.mjs'),"/src/content/docs/zh-cn/welcome-to-docs.mdx": () => import('./welcome-to-docs_BPWR30KL.mjs'),"/src/content/insights/insight-1.md": () => import('./insight-1_C_UCWEWJ.mjs'),"/src/content/insights/insight-2.md": () => import('./insight-2_t7cDvjIu.mjs'),"/src/content/insights/insight-3.md": () => import('./insight-3_COmSfQYO.mjs'),"/src/content/products/a765.md": () => import('./a765_5CqYZQEM.mjs'),"/src/content/products/b203.md": () => import('./b203_Djqvz-PE.mjs'),"/src/content/products/f303.md": () => import('./f303_CZiC7Qx0.mjs'),"/src/content/products/t845.md": () => import('./t845_BxWkfrO_.mjs')});
...
let lookupMap = {};
lookupMap = {"blog":{"type":"content","entries":{"post-1":"/src/content/blog/post-1.md","post-2":"/src/content/blog/post-2.md","post-3":"/src/content/blog/post-3.md"}},"docs":{"type":"content","entries":{"welcome-to-docs":"/src/content/docs/welcome-to-docs.mdx","advanced/technical-specifications":"/src/content/docs/advanced/technical-specifications.mdx","construction/custom-solutions":"/src/content/docs/construction/custom-solutions.mdx","construction/project-planning":"/src/content/docs/construction/project-planning.mdx","construction/safety":"/src/content/docs/construction/safety.mdx","construction/service-overview":"/src/content/docs/construction/service-overview.mdx","de/welcome-to-docs":"/src/content/docs/de/welcome-to-docs.mdx","es/welcome-to-docs":"/src/content/docs/es/welcome-to-docs.mdx","fa/welcome-to-docs":"/src/content/docs/fa/welcome-to-docs.mdx","fr/welcome-to-docs":"/src/content/docs/fr/welcome-to-docs.mdx","guides/first-project-checklist":"/src/content/docs/guides/first-project-checklist.mdx","guides/getting-started":"/src/content/docs/guides/getting-started.mdx","guides/intro":"/src/content/docs/guides/intro.mdx","ja/welcome-to-docs":"/src/content/docs/ja/welcome-to-docs.mdx","tools/equipment-care":"/src/content/docs/tools/equipment-care.mdx","tools/tool-guides":"/src/content/docs/tools/tool-guides.mdx","zh-cn/welcome-to-docs":"/src/content/docs/zh-cn/welcome-to-docs.mdx","de/guides/first-project-checklist":"/src/content/docs/de/guides/first-project-checklist.mdx","de/guides/getting-started":"/src/content/docs/de/guides/getting-started.mdx","de/guides/intro":"/src/content/docs/de/guides/intro.mdx","es/guides/getting-started":"/src/content/docs/es/guides/getting-started.mdx","es/guides/first-project-checklist":"/src/content/docs/es/guides/first-project-checklist.mdx","es/guides/intro":"/src/content/docs/es/guides/intro.mdx","fa/guides/first-project-checklist":"/src/content/docs/fa/guides/first-project-checklist.mdx","fa/guides/getting-started":"/src/content/docs/fa/guides/getting-started.mdx","fa/guides/intro":"/src/content/docs/fa/guides/intro.mdx","fr/guides/first-project-checklist":"/src/content/docs/fr/guides/first-project-checklist.mdx","fr/guides/getting-started":"/src/content/docs/fr/guides/getting-started.mdx","fr/guides/intro":"/src/content/docs/fr/guides/intro.mdx","ja/guides/first-project-checklist":"/src/content/docs/ja/guides/first-project-checklist.mdx","ja/guides/getting-started":"/src/content/docs/ja/guides/getting-started.mdx","ja/guides/intro":"/src/content/docs/ja/guides/intro.mdx","zh-cn/guides/first-project-checklist":"/src/content/docs/zh-cn/guides/first-project-checklist.mdx","zh-cn/guides/getting-started":"/src/content/docs/zh-cn/guides/getting-started.mdx","zh-cn/guides/intro":"/src/content/docs/zh-cn/guides/intro.mdx"}},"insights":{"type":"content","entries":{"insight-1":"/src/content/insights/insight-1.md","insight-2":"/src/content/insights/insight-2.md","insight-3":"/src/content/insights/insight-3.md"}},"products":{"type":"content","entries":{"a765":"/src/content/products/a765.md","b203":"/src/content/products/b203.md","f303":"/src/content/products/f303.md","t845":"/src/content/products/t845.md"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/post-1.md": () => import('./post-1_EHZ_zpzK.mjs'),"/src/content/blog/post-2.md": () => import('./post-2_ijQDU7mS.mjs'),"/src/content/blog/post-3.md": () => import('./post-3_Bw7GhWjp.mjs'),"/src/content/docs/advanced/technical-specifications.mdx": () => import('./technical-specifications_CjBV-ucE.mjs'),"/src/content/docs/construction/custom-solutions.mdx": () => import('./custom-solutions_APKvSdND.mjs'),"/src/content/docs/construction/project-planning.mdx": () => import('./project-planning_c1W003hs.mjs'),"/src/content/docs/construction/safety.mdx": () => import('./safety_PQyZOrEd.mjs'),"/src/content/docs/construction/service-overview.mdx": () => import('./service-overview_BeDLJap0.mjs'),"/src/content/docs/de/guides/first-project-checklist.mdx": () => import('./first-project-checklist_Br29TAzE.mjs'),"/src/content/docs/de/guides/getting-started.mdx": () => import('./getting-started_BxAQ7hLp.mjs'),"/src/content/docs/de/guides/intro.mdx": () => import('./intro_B3Z0hVnq.mjs'),"/src/content/docs/de/welcome-to-docs.mdx": () => import('./welcome-to-docs_CgQTjgcF.mjs'),"/src/content/docs/es/guides/first-project-checklist.mdx": () => import('./first-project-checklist_CxJ8fqmG.mjs'),"/src/content/docs/es/guides/getting-started.mdx": () => import('./getting-started_UX_wX3Tu.mjs'),"/src/content/docs/es/guides/intro.mdx": () => import('./intro_BDjZpkuk.mjs'),"/src/content/docs/es/welcome-to-docs.mdx": () => import('./welcome-to-docs_42KzSvpm.mjs'),"/src/content/docs/fa/guides/first-project-checklist.mdx": () => import('./first-project-checklist_mV3ljcwe.mjs'),"/src/content/docs/fa/guides/getting-started.mdx": () => import('./getting-started_B5BveESy.mjs'),"/src/content/docs/fa/guides/intro.mdx": () => import('./intro_YyQ0BjZg.mjs'),"/src/content/docs/fa/welcome-to-docs.mdx": () => import('./welcome-to-docs_CeO40sDw.mjs'),"/src/content/docs/fr/guides/first-project-checklist.mdx": () => import('./first-project-checklist_BcRKwYVh.mjs'),"/src/content/docs/fr/guides/getting-started.mdx": () => import('./getting-started_DpbkzNYK.mjs'),"/src/content/docs/fr/guides/intro.mdx": () => import('./intro_D0YhCMTT.mjs'),"/src/content/docs/fr/welcome-to-docs.mdx": () => import('./welcome-to-docs_C9dwgjYV.mjs'),"/src/content/docs/guides/first-project-checklist.mdx": () => import('./first-project-checklist_CKvOtXkW.mjs'),"/src/content/docs/guides/getting-started.mdx": () => import('./getting-started_R91iEiEQ.mjs'),"/src/content/docs/guides/intro.mdx": () => import('./intro_kPH35Mcg.mjs'),"/src/content/docs/ja/guides/first-project-checklist.mdx": () => import('./first-project-checklist_C8yhHiyI.mjs'),"/src/content/docs/ja/guides/getting-started.mdx": () => import('./getting-started_D8NsIHzb.mjs'),"/src/content/docs/ja/guides/intro.mdx": () => import('./intro_B9q_egfz.mjs'),"/src/content/docs/ja/welcome-to-docs.mdx": () => import('./welcome-to-docs_kwIJXZQj.mjs'),"/src/content/docs/tools/equipment-care.mdx": () => import('./equipment-care_Cjx5uqqa.mjs'),"/src/content/docs/tools/tool-guides.mdx": () => import('./tool-guides_BHVUrNAR.mjs'),"/src/content/docs/welcome-to-docs.mdx": () => import('./welcome-to-docs_DxjKYpUJ.mjs'),"/src/content/docs/zh-cn/guides/first-project-checklist.mdx": () => import('./first-project-checklist_DdU_Au9b.mjs'),"/src/content/docs/zh-cn/guides/getting-started.mdx": () => import('./getting-started_CJ0yLlnY.mjs'),"/src/content/docs/zh-cn/guides/intro.mdx": () => import('./intro_B-ielO1v.mjs'),"/src/content/docs/zh-cn/welcome-to-docs.mdx": () => import('./welcome-to-docs_HAAQaToA.mjs'),"/src/content/insights/insight-1.md": () => import('./insight-1_39_0Y-9I.mjs'),"/src/content/insights/insight-2.md": () => import('./insight-2_DAu81O04.mjs'),"/src/content/insights/insight-3.md": () => import('./insight-3_AQxTso1H.mjs'),"/src/content/products/a765.md": () => import('./a765_Dc6MPhfo.mjs'),"/src/content/products/b203.md": () => import('./b203_Cs59EGmZ.mjs'),"/src/content/products/f303.md": () => import('./f303_CLAWFzwq.mjs'),"/src/content/products/t845.md": () => import('./t845_BMqkilYl.mjs')});
...
const $$Astro$$ = createAstro("https://vanitysuds.com");
...
const $$$1 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": pageTitle }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="py-6 sm:py-8 lg:py-12"> <div class="mx-auto max-w-screen-xl px-4 md:px-8"> <div class="grid gap-8 md:grid-cols-2 lg:gap-12"> <div> <div class="h-64 overflow-hidden rounded-lg shadow-lg md:h-auto"> ${renderComponent($$result2, "Image", $$Image, { "class": "h-full w-full object-cover object-center", "src": post.data.cardImage, "alt": post.data.cardImageAlt, "draggable": "false", "format": "avif" })} </div> </div> <div class="md:pt-8"> <h1 class="mb-4 text-balance text-center text-2xl font-bold text-neutral-800 dark:text-neutral-200 sm:text-3xl md:mb-6 md:text-left"> ${post.data.title} </h1> <div class="space-y-8"> ${post.data.contents.map((content) => renderTemplate`<p class="text-pretty text-lg text-neutral-700 dark:text-neutral-300"> ${content} </p>`)} </div> </div> </div> </div> </section> ` })}`;
}, "/workspaces/newvanitysuds/src/pages/insights/[...slug].astro", void 0);

const $$file$5 = "/workspaces/newvanitysuds/src/pages/insights/[...slug].astro";
...
const icon = new Proxy({"src":"/_astro/icon.BJD5tiNw.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/icon.png";
							}
...
const maskableIcon = new Proxy({"src":"/_astro/icon-maskable.C1A7b-dw.png","width":1024,"height":1024,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/icon-maskable.png";
							}
...
const $$Astro$_ = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/ui/cards/CardSmall.astro", void 0);

const $$Astro$Z = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/ui/cards/CardWide.astro", void 0);
...
const product5 = new Proxy({"src":"/_astro/features-image.BEGIe8fA.avif","width":4375,"height":2369,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/features-image.avif";
							}
...
const $$Astro$Y = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/sections/features/FeaturesStatsAlt.astro", void 0);

const $$Astro$X = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/ui/avatars/AvatarTestimonialSection.astro", void 0);

const $$Astro$W = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/sections/testimonials/TestimonialsSectionAlt.astro", void 0);

const $$Astro$V = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/pages/products/index.astro", void 0);

const $$file$4 = "/workspaces/newvanitysuds/src/pages/products/index.astro";
...
const $$Astro$U = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/ui/buttons/ProductTabBtn.astro", void 0);

var __freeze$3 = Object.freeze;
var __defProp$3 = Object.defineProperty;
var __template$3 = (cooked, raw) => __freeze$3(__defProp$3(cooked, "raw", { value: __freeze$3(raw || cooked.slice()) }));
var _a$3;
const $$Astro$T = createAstro("https://vanitysuds.com");
...
const $$ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": pageTitle }, { "default": ($$result2) => renderTemplate(_a$3 || (_a$3 = __template$3([" ", '<div id="overlay" class="fixed inset-0 bg-neutral-200 dark:bg-neutral-800"></div> <section class="mx-auto flex max-w-[85rem] flex-col px-4 py-10 sm:px-6 lg:px-8 lg:py-14 2xl:max-w-full"> <div> <p id="fadeText" class="mb-8 max-w-prose text-pretty font-light text-neutral-700 dark:text-neutral-300 sm:text-xl"> ', ' </p> </div> <div class="flex flex-col items-center justify-between space-y-4 sm:flex-row sm:space-y-0"> <div id="fadeInUp"> <h1 class="block text-4xl font-bold tracking-tighter text-neutral-800 dark:text-neutral-200 sm:text-5xl md:text-6xl lg:text-7xl"> ', ' </h1> <p class="text-lg text-neutral-600 dark:text-neutral-400"> ', " </p> </div> <div> ", ' </div> </div> </section> <div class="mx-auto max-w-[85rem] px-4 pt-10 sm:px-6 lg:px-8 lg:pt-14"> <nav class="mx-auto grid max-w-6xl gap-y-px sm:flex sm:gap-x-4 sm:gap-y-0" aria-label="Tabs" role="tablist"> ', ' </nav> <div class="mt-12 md:mt-16"> <div id="tabs-with-card-1" role="tabpanel"> <div class="mx-auto max-w-[85rem] px-4 pb-10 sm:px-6 lg:px-8 lg:pb-14"> <div class="grid gap-12 md:grid-cols-2"> <div class="lg:w-3/4"> <h2 class="text-balance text-3xl font-bold tracking-tight text-neutral-800 dark:text-neutral-200 md:leading-tight lg:text-4xl"> ', ' </h2> <p class="mt-3 text-pretty text-neutral-600 dark:text-neutral-400"> ', ' </p> <p class="mt-5"> ', ' </p> </div> <div class="space-y-6 lg:space-y-10"> ', ' </div> </div> </div> </div> <div id="tabs-with-card-2" class="hidden" role="tabpanel"> <div class="mx-auto max-w-[85rem] px-4 pb-10 sm:px-6 lg:px-8 lg:pb-14"> <div class="grid w-full grid-cols-1 gap-x-16 md:grid-cols-2"> <div class="max-w-md space-y-6"> ', ' </div> <div class="mt-6 max-w-md space-y-6 md:ml-auto md:mt-0"> ', ' </div> </div> </div> </div> </div> </div> <div id="tabs-with-card-3" class="hidden" role="tabpanel"> <div class="mx-auto mb-20 flex w-full md:mb-28 2xl:w-4/5"> <div class="relative left-12 top-12 z-10 overflow-hidden rounded-xl shadow-lg md:left-12 md:top-16 md:-ml-12 lg:ml-0"> ', ' </div> <div class="relative right-12 overflow-hidden rounded-xl shadow-xl"> ', ' </div> </div> </div> <script src="/scripts/vendor/gsap/gsap.min.js"><\/script> ', " ", " "])), maybeRenderHead(), product.data.main.content, product.data.title, product.data.description, renderComponent($$result2, "Image", $$Image, { "id": "fadeInMoveRight", "src": product.data.main.imgMain, "class": "w-[600px]", "alt": product.data.main.imgAlt, "format": "avif", "loading": "eager" }), product.data.tabs.map((tab, index) => renderTemplate`${renderComponent($$result2, "ProductTabBtn", $$ProductTabBtn, { "title": tab.title, "id": tab.id, "dataTab": tab.dataTab, "first": index === 0 })}`), product.data.longDescription.title, product.data.longDescription.subTitle, renderComponent($$result2, "PrimaryCTA", $$PrimaryCTA, { "title": product.data.longDescription.btnTitle, "url": product.data.longDescription.btnURL }), product.data.descriptionList.map((list) => renderTemplate`<div class="flex"> <div> <h3 class="text-base font-bold text-neutral-800 dark:text-neutral-200 sm:text-lg"> ${list.title} </h3> <p class="mt-1 text-neutral-600 dark:text-neutral-400"> ${list.subTitle} </p> </div> </div>`), product.data.specificationsLeft.map((spec) => renderTemplate`<div> <h3 class="block font-bold text-neutral-800 dark:text-neutral-200"> ${spec.title} </h3> <p class="text-neutral-600 dark:text-neutral-400"> ${spec.subTitle} </p> </div>`), product.data.specificationsRight?.map((spec) => renderTemplate`<div> <h3 class="block font-bold text-neutral-800 dark:text-neutral-200"> ${spec.title} </h3> <p class="text-neutral-600 dark:text-neutral-400"> ${spec.subTitle} </p> </div>`), product.data.blueprints.first && renderTemplate`${renderComponent($$result2, "Image", $$Image, { "src": product.data.blueprints.first, "class": "h-full w-full object-cover object-center", "alt": "Blueprint Illustration", "format": "avif" })}`, product.data.blueprints.second && renderTemplate`${renderComponent($$result2, "Image", $$Image, { "src": product.data.blueprints.second, "class": "h-full w-full object-cover object-center", "alt": "Blueprint Illustration", "format": "avif" })}`, renderScript($$result2, "/workspaces/newvanitysuds/src/pages/products/[...slug].astro?astro&type=script&index=0&lang.ts"), renderScript($$result2, "/workspaces/newvanitysuds/src/pages/products/[...slug].astro?astro&type=script&index=1&lang.ts")) })}`;
}, "/workspaces/newvanitysuds/src/pages/products/[...slug].astro", void 0);

const $$file$3 = "/workspaces/newvanitysuds/src/pages/products/[...slug].astro";
...
Sitemap: ${new URL("sitemap-index.xml", "https://vanitysuds.com").href}
`.trim();
const GET = () => {
...
const $$Astro$S = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/ui/blocks/MainSection.astro", void 0);

const $$Astro$R = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/ui/blocks/LeftSection.astro", void 0);

const $$Astro$Q = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/ui/blocks/RightSection.astro", void 0);

const $$Astro$P = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/ui/blocks/StatsBig.astro", void 0);

const $$Astro$O = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/ui/blocks/StatsSmall.astro", void 0);

const $$Astro$N = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/sections/features/FeaturesStats.astro", void 0);
...
const blueprints = new Proxy({"src":"/_astro/blueprints-image.DxAt2gto.avif","width":1333,"height":2000,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/blueprints-image.avif";
							}
...
const personWorking = new Proxy({"src":"/_astro/person-working.aUGgRiE_.avif","width":1334,"height":2000,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/person-working.avif";
							}
...
const beforeAfter = new Proxy({"src":"/_astro/before-after.BntBToq6.avif","width":2048,"height":1366,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/before-after.avif";
							}
...
const constructionWorkers = new Proxy({"src":"/_astro/construction-workers.XhU7Ouf4.avif","width":1920,"height":1280,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/construction-workers.avif";
							}
...
const aerialView = new Proxy({"src":"/_astro/aerial-view.CeV30CXX.avif","width":1920,"height":1282,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/aerial-view.avif";
							}
...
const usingTools = new Proxy({"src":"/_astro/using-tools.BrEE8t5H.avif","width":1920,"height":1280,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/using-tools.avif";
							}
...
const progressBuilding = new Proxy({"src":"/_astro/progress-building.Cjca0suI.avif","width":1920,"height":2560,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/progress-building.avif";
							}
...
const underConstruction = new Proxy({"src":"/_astro/under-construction.DfISh1yq.avif","width":1920,"height":2876,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/under-construction.avif";
							}
...
const $$Astro$M = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/pages/services.astro", void 0);

const $$file$2 = "/workspaces/newvanitysuds/src/pages/services.astro";
...
const $$Astro$L = createAstro("https://vanitysuds.com");
const $$SecondaryCTA = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const darkClasses = "dark:border-primary dark:bg-zinc-900 dark:text-neutral-300 dark:ring-zinc-200 dark:hover:bg-zinc-800 dark:focus:outline-none";
...
}, "/workspaces/newvanitysuds/src/components/ui/buttons/SecondaryCTA.astro", void 0);

const $$Astro$K = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/ui/stars/FullStar.astro", void 0);

const $$Astro$J = createAstro("https://vanitysuds.com");
const $$ReviewComponent = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="mt-6 lg:mt-10"> <div class="py-5"> <div class="text-center sm:flex sm:items-center sm:text-start"> <div class="flex-shrink-0 pb-5 sm:flex sm:pb-0 sm:pe-5"></div> <div class="mx-auto h-px w-32 border-t border-neutral-400 dark:border-neutral-500 sm:mx-0 sm:h-8 sm:w-auto sm:border-s sm:border-t-0"></div> <!-- Review Ratings --> <div class="flex flex-col items-center sm:items-start"> <div class="flex items-baseline space-x-1 pt-5 sm:ps-5 sm:pt-0"> <div class="flex space-x-1"> <!-- Your star ratings --> ${Array(starCount).fill(0).map((_, i) => renderTemplate`${renderComponent($$result, "FullStar", $$FullStar, { "key": i })}`)} <!-- Adding additional half-star --> </div> <p class="text-neutral-800 dark:text-neutral-200"> ${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(rating)}` })} </p> </div> <div class="text-sm text-neutral-800 dark:text-neutral-200 sm:ps-5"> <a href="https://www.google.com/search?q=Vanity+Suds+Detailing&oq=vanity+suds&gs_lcrp=EgZjaHJvbWUqCAgAEEUYJxg7MggIABBFGCcYOzIGCAEQRRg7MgYIAhBFGEAyBggDEEUYOzIGCAQQRRg7MgYIBRBFGDwyBggGEEUYPDIGCAcQRRg80gEIMTc5M2owajmoAgCwAgA&sourceid=chrome&ie=UTF-8#" <Fragment>${unescapeHTML(reviews)}</a> </div> </div> </div> </div> </div>`;
}, "/workspaces/newvanitysuds/src/components/ui/blocks/ReviewComponent.astro", void 0);

const $$Astro$I = createAstro("https://vanitysuds.com");
...
const $$HeroSectionAlt = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="relative mx-auto max-w-[85rem] px-4 pb-24 pt-10 sm:px-6 lg:px-8"> <!-- Hero Section Heading --> <div class="mx-auto mt-5 max-w-xl text-center"> <h2 class="block text-balance text-4xl font-bold leading-tight tracking-tight text-neutral-800 dark:text-neutral-200 md:text-5xl lg:text-6xl"> ${title} </h2> </div> <!-- Hero Section Sub-heading --> <div class="mx-auto mt-5 max-w-3xl text-center"> ${subTitle && renderTemplate`<p class="text-pretty text-lg text-neutral-600 dark:text-neutral-400"> ${subTitle} </p>`} </div> <!-- Github Button --> ${url && renderTemplate`<div class="mt-8 flex justify-center gap-3"> ${renderComponent($$result, "PrimaryCTA", $$PrimaryCTA, { "title": "Book Appointment", "url": "/book" })} </div>`} </section>`;
}, "/workspaces/newvanitysuds/src/components/sections/landing/HeroSectionAlt.astro", void 0);

const $$Astro$G = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/ui/blocks/IconBlock.astro", void 0);

const $$Astro$F = createAstro("https://vanitysuds.com");
const $$FeaturesGeneral = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 2xl:max-w-full"> <!-- Block to display the feature image --> <div class="relative mb-6 overflow-hidden md:mb-8 flex justify-center items-center"></div> <!-- Displaying the main content consisting of title, subtitle, and several \`IconBlock\` components --> <div class="mt-5 grid gap-8 lg:mt-16 lg:grid-cols-3 lg:gap-12"> <!-- Block for title and subtitle --> <div class="lg:col-span-1"> <!-- Rendering title --> <h2 class="text-balance text-2xl font-bold text-neutral-800 dark:text-neutral-200 md:text-3xl"> ${title} </h2> <!-- Rendering subtitle --> ${subTitle && renderTemplate`<p class="mt-2 text-pretty text-neutral-600 dark:text-neutral-400 md:mt-4"> ${subTitle} </p>`} </div> <!-- Block to display the IconBlock components --> <div class="lg:col-span-2"> <div class="grid gap-8 sm:grid-cols-2 md:gap-12"> <!-- Injecting IconBlock components with different properties --> ${features && features.map((feature) => renderTemplate`${renderComponent($$result, "IconBlock", $$IconBlock, { "heading": feature.heading, "content": feature.content }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Icon", $$Icon$1, { "name": feature.svg })} ` })}`)} </div> </div> </div> </section>`;
}, "/workspaces/newvanitysuds/src/components/sections/features/FeaturesGeneral.astro", void 0);

const $$Astro$E = createAstro("https://vanitysuds.com");
const $$TabNav = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<!-- Tab button with dynamic class based on 'first' property, id, tab data, and aria-controls  -->${maybeRenderHead()}<button type="button"${addAttribute(`${first ? "active " : ""}${BUTTON_CLASS}`, "class")}${addAttribute(id, "id")}${addAttribute(dataTab, "data-hs-tab")}${addAttribute(aria, "aria-controls")} role="tab"> <!-- Slot for additional content --> <span class="flex"> ${renderSlot($$result, $$slots["default"])} <!-- Container for the heading and content of the tab --> <span class="ms-6 grow"> <!-- Heading of the tab, changes color when active --> <span class="block text-lg font-bold text-neutral-800 hs-tab-active:text-primary dark:text-neutral-200 dark:hs-tab-active:text-primary">${heading}</span> <!-- Content of the tab, changes color when active --> <span class="mt-1 block text-neutral-500 hs-tab-active:text-neutral-600 dark:text-neutral-400 dark:hs-tab-active:text-neutral-200">${content}</span> </span> </span> </button>`;
}, "/workspaces/newvanitysuds/src/components/ui/blocks/TabNav.astro", void 0);

const $$Astro$D = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/ui/blocks/TabContent.astro", void 0);

var __freeze$2 = Object.freeze;
var __defProp$2 = Object.defineProperty;
var __template$2 = (cooked, raw) => __freeze$2(__defProp$2(cooked, "raw", { value: __freeze$2(raw || cooked.slice()) }));
var _a$2;
const $$Astro$C = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/src/components/sections/features/FeaturesNavs.astro", void 0);

const $$Astro$B = createAstro("https://vanitysuds.com");
const $$TestimonialItem = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<blockquote class="relative mb-24 mt-24"> ${renderComponent($$result, "Icon", $$Icon$1, { "name": "quotation" })} <div class="relative z-10"> <p class="text-xl italic text-neutral-800 dark:text-neutral-200"> ${content} </p> </div> <div class="mt-6"> <div class="flex items-center"> <div class="flex-shrink-0"></div> <div class="ms-4 grow"> <div class="font-bold text-neutral-800 dark:text-neutral-200"> ${author} </div> <div class="text-xs text-neutral-500">${role}</div> </div> </div> </div> </blockquote>`;
}, "/workspaces/newvanitysuds/src/components/sections/testimonials/TestimonialItem.astro", void 0);

const $$Astro$A = createAstro("https://vanitysuds.com");
const $$TestimonialsSection = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 2xl:max-w-full"> <!-- Container for the testimonials --> <div class="lg:grid lg:grid-cols-2 lg:items-center lg:justify-between lg:gap-16"> <div class="lg:col-span-5 lg:col-start-1"> <!-- Title and Subtitle --> <div class="mb-8"> <h2 class="mb-2 text-3xl font-bold text-neutral-800 dark:text-neutral-200 lg:text-4xl"> ${title} </h2> ${subTitle && renderTemplate`<p class="text-neutral-600 dark:text-neutral-400"> ${subTitle} </p>`} </div> <!-- Generate a blockquote for each testimonial in the testimonials array by mapping over the array. --> ${testimonials && testimonials.map((testimonial) => renderTemplate`${renderComponent($$result, "TestimonialItem", $$TestimonialItem, { "content": testimonial.content, "author": testimonial.author, "role": testimonial.role })}`)} </div> </div> </section>`;
}, "/workspaces/newvanitysuds/src/components/sections/testimonials/TestimonialsSection.astro", void 0);

const heroImage = new Proxy({"src":"/_astro/logo-2.tB_632-z.png","width":2000,"height":2000,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/logos/logo-2.png";
							}
...
const features = [
	{
		...
		content: "Benefit from our Mobile Service and have us come to you! No need to worry about dropping your car off. We can detail anywhere that has a water and outlet source!",
		svg: "mobile"
	},
	{
		heading: "Experienced Detailers",
		content: "Our staff have years of experience with detailing, even including Collision Repair & Refinishing! Our staff have gone thru training to make sure we offer high quality services.",
		svg: "verified"
	},
	{
		heading: "Top-Rated Chemicals",
		content: "We use top-quality chemicals by companies such as P&S, 3D, KochChemie and more! This provides us the ability to offer quality services with outstanding results and longetivity!",
		svg: "chemical"
	},
	{
		heading: "Customer Satisfaction",
		content: "Our main priority is to provide exceptional service to our customers. We stand by creating a great experience and having pride in customer satisfaction!",
		svg: "customer"
	}
];

const featureImage = new Proxy({"src":"/_astro/featured.BngDjJeL.jpeg","width":3021,"height":2266,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/featured.jpeg";
							}
...
const dad = new Proxy({"src":"/_astro/dad.CwtQ_6On.png","width":3024,"height":4032,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/cars/dad.png";
							}
...
const mustang = new Proxy({"src":"/_astro/mustang.DYENFDw3.png","width":3024,"height":4032,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/cars/mustang.png";
							}
...
const mine = new Proxy({"src":"/_astro/mine.DV7Q6NDs.png","width":3024,"height":4032,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/cars/mine.png";
							}
...
const Newsletter = () => {
  ...
  return /* @__PURE__ */ jsx("section", { children: /* @__PURE__ */ jsx("div", { className: "py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6", children: /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "w-full", children: [
          /* @__PURE__ */ jsx("h2", { className: "mb-4 text-3xl font-bold tracking-tight sm:text-4xl text-primary", children: "Sign Up For Our Newsletter" }),
          /* @__PURE__ */ jsx("p", { className: "font-light text-white sm:text-xl", children: "Stay up to date with deals/discounts, announcements, special events and more!" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-6 w-full lg:mt-0", children: [
          /* @__PURE__ */ jsx("form", { onSubmit: handleSubmit(onSubmit), children: /* @__PURE__ */ jsxs("div", { className: "items-center mb-3 space-y-4 sm:flex sm:space-y-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "relative w-full", children: [
              ...
              /* @__PURE__ */ jsx("div", { className: "flex absolute inset-y-0 left-0 items-center pl-3 pointer-events-none", children: /* @__PURE__ */ jsxs(
                "svg",
                {
...
const $$Index$1 = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$z, $$props, $$slots);
  Astro2.self = $$Index$1;
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, {}, { "default": ($$result2) => renderTemplate`  ${renderComponent($$result2, "HeroSection", $$HeroSection, { "title": `Mobile Detailing in <span
    class="text-primary dark:text-primary">Pittsburgh</span>`, "subTitle": "Top-quality detailing services and expert ceramic coating services for your vehicle - wherever, whenever!", "primaryBtn": "Book Appointment", "primaryBtnURL": "/book", "secondaryBtn": "Our Instagram", "secondaryBtnURL": "https://instagram.com/vanitysuds", "withReview": true, "rating": `<span class="font-bold">5</span> / 5`, "starCount": 5, "reviews": `View Reviews`, "src": heroImage, "alt": "Stack of ScrewFast product boxes containing assorted hardware tools" })} ${renderComponent($$result2, "FeaturesGeneral", $$FeaturesGeneral, { "title": "Top-Tier Mobile Detailing", "subTitle": "At Vanity Suds, we offer high quality detailing services around the Pittsburgh Area. From cutting-edge tools/chemicals to expert services, we're dedicated to making your vehicle look new again while giving great customer service!", "src": featureImage, "alt": "ScrewFast products in floating boxes", "features": features })} ${renderComponent($$result2, "FeaturesNavs", $$FeaturesNavs, { "title": `We offer many services to perfectly suit your expectations and cars needs.`, "tabs": [
    {
      heading: "Interior Services",
      content: "Our interior services will have your cars inside looking brand new! We offer vacuuming, extractions, steaming, pet hair removal, stain removal and more!",
      svg: "vacuum",
      src: dad,
    ...
    {
      heading: "Exterior Services",
      content: "Our exterior services will have your cars exterior showroom ready! Our exterior services include 2 bucket hand wash, iron decon, claybar, paint corrections, ceramic coatings and more!",
      svg: "soap",
      src: mustang,
    ...
    {
      heading: "Coatings & Paint Corrections",
      content: "Restore your vehicles paint with a paint correction and ceramic coating! This service will remove scratches and bring the shine back to your paint while also protecting it and adding enhanced water repelling capabilities!",
      svg: "sparkle",
      src: mine,
      alt: "Gray metal building frame near tower crane during daytime"
    }
  ] })} ${renderComponent($$result2, "Newsletter", Newsletter, { "client:visible": true, "client:component-hydration": "visible", "client:component-path": "@/components/forms/Newsletter", "client:component-export": "default" })} ${renderComponent($$result2, "TestimonialsSection", $$TestimonialsSection, { "title": "What Our Customers Say", "subTitle": "Our Main Priority Is Customer Satisfaction, So Heres What Our Customers Say About Us!", ";": true, "testimonials": [
    {
      content: "Jakobi showed up and was very friendly. I got the premium exterior, and basic interior package and he did a great job giving the cars paint a good cleaning which it needed. He really took his time and made sure it was done right car looks great and smells amazing inside",
      author: "Joshua Arbogast",
      role: "Vanity Suds Customer"
    },
    {
      content: `Highly recommend! I googled "mobile detailers" and booked an appointment with the first company I saw with online booking.  They cancelled on me last minute, but thankfully Vanity Suds was able to fit my son\u2019s car in the next day. Jonah & Jakobi did a fantastic job- super friendly and extremely thorough.`,
      author: "Tracey Mozeyko",
      role: "Vanity Suds Customer"
    }
  ] })} ${renderComponent($$result2, "HeroSectionAlt", $$HeroSectionAlt, { "title": "Let's Work Together", "subTitle": "Vanity Suds is open Monday-Saturday, so visit our booking page to book today!", "url": "https://github.com/mearashadowfax/ScrewFast" })} ` })}`;
}, "/workspaces/newvanitysuds/src/pages/index.astro", void 0);

const $$file$1 = "/workspaces/newvanitysuds/src/pages/index.astro";
const $$url$1 = "";
...
const docs$1 = (await getCollection("docs") ?? []).map(
  ({ slug, ...entry }) => ({
    ...entry,
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/Banner.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/ContentPanel.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/user-components/Icon.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/FallbackContentNotice.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/EditLink.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/LastUpdated.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/Pagination.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/Footer.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/Head.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/Select.astro", void 0);
...
const $$LanguageSelect = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${starlightConfig.isMultilingual && renderTemplate`${renderComponent($$result, "starlight-lang-select", "starlight-lang-select", {}, { "default": () => renderTemplate`${renderComponent($$result, "Select", $$Select, { "icon": "translate", "label": labels["languageSelect.accessibleLabel"], "value": localizedPathname(Astro2.props.locale), "options": Object.entries(starlightConfig.locales).map(([code, locale]) => ({
    ...
    label: locale.label
  })), "width": "7em" })}` })}`}${renderScript($$result, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/LanguageSelect.astro?astro&type=script&index=0&lang.ts")}`;
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/LanguageSelect.astro", void 0);
...
const $$SiteTitle = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<span class="site-title flex astro-cdy74xqe"> <a class="main-logo astro-cdy74xqe"${addAttribute(main, "href")} aria-label="Astro">${unescapeHTML(logo)}</a> <a class="docs-logo astro-cdy74xqe"${addAttribute(self, "href")} aria-label="Docs">${unescapeHTML(docs)}</a> </span> `;
}, "/workspaces/newvanitysuds/src/components/ui/starlight/SiteTitle.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/SocialIcons.astro", void 0);
...
const $$ThemeSelect = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ], "width": "6.25em" })} ` }), renderScript($$result, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/ThemeSelect.astro?astro&type=script&index=0&lang.ts"));
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/ThemeSelect.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/Header.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/CallToAction.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/Hero.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/MarkdownContent.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/PageFrame.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/TableOfContents/TableOfContentsList.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/PageSidebar.astro", void 0);

const $$Astro$9 = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/PageTitle.astro", void 0);

const $$Astro$8 = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/MobileMenuFooter.astro", void 0);

const $$Astro$7 = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/Badge.astro", void 0);

const $$Astro$6 = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/SidebarSublist.astro", void 0);

const $$Astro$5 = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/Sidebar.astro", void 0);

const $$Astro$4 = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/SkipLink.astro", void 0);

var __freeze = Object.freeze;
var __defProp = Object.defineProperty;
var __template = (cooked, raw) => __freeze(__defProp(cooked, "raw", { value: __freeze(raw || cooked.slice()) }));
var _a;
const $$Astro$3 = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/ThemeProvider.astro", void 0);

const $$Astro$2 = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/TwoColumnContent.astro", void 0);

const $$Astro$1 = createAstro("https://vanitysuds.com");
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/components/Page.astro", void 0);
...
}, "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/index.astro", void 0);

const $$file = "/workspaces/newvanitysuds/node_modules/@astrojs/starlight/index.astro";
const $$url = undefined;
...
export { $$Icon as $, Icons as I, _404 as _, useTranslations as a, starlightConfig as b, _slug_ as c, definitions as d, book as e, contact as f, favicon_ico as g, ____slug_$1 as h, index$3 as i, index$2 as j, ____slug_ as k, services as l, manifest_json as m, index$1 as n, index as o, robots_txt as r, slugToLocaleData as s, urlToSlug as u };
