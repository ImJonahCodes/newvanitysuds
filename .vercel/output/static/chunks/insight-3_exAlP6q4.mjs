const id = "insight-3.md";
					...
					,cardImageAlt:"Top view mechanical tools arrangement"};
						const _internal = {
							type: 'content',
							filePath: "/workspaces/newvanitysuds/src/content/insights/insight-3.md",
							rawData: undefined,
						};
