...
}, "/workspaces/newvanitysuds/node_modules/astro/components/Image.astro", void 0);
...
const ogImageSrc = new Proxy({"src":"/_astro/social.CWnIx2-K.png","width":1200,"height":600,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/social.png";
							}
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/social.png");
							return target[name];
						}
					});
...
const faviconSvgSrc = new Proxy({"src":"/_astro/icon.B7KHh505.svg","width":512,"height":512,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/workspaces/newvanitysuds/src/images/icon.svg";
							}
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/icon.svg");
							return target[name];
						}
					});
...
const icon = new Proxy({"src":"/_astro/icon.BJD5tiNw.png","width":512,"height":512,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/icon.png");
							return target[name];
						}
					});
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/post-1.md": () => import('./post-1_B820fkCG.mjs'),"/src/content/blog/post-2.md": () => import('./post-2_BWPyloZb.mjs'),"/src/content/blog/post-3.md": () => import('./post-3_ZadhAqb9.mjs'),"/src/content/docs/advanced/technical-specifications.mdx": () => import('./technical-specifications_BDLtSvxi.mjs'),"/src/content/docs/construction/custom-solutions.mdx": () => import('./custom-solutions_D018Hdhh.mjs'),"/src/content/docs/construction/project-planning.mdx": () => import('./project-planning_DoXdpVE4.mjs'),"/src/content/docs/construction/safety.mdx": () => import('./safety_DYlEOqp2.mjs'),"/src/content/docs/construction/service-overview.mdx": () => import('./service-overview_D8gMpD-G.mjs'),"/src/content/docs/de/guides/first-project-checklist.mdx": () => import('./first-project-checklist_BgRmLQxV.mjs'),"/src/content/docs/de/guides/getting-started.mdx": () => import('./getting-started_BhxzYmTp.mjs'),"/src/content/docs/de/guides/intro.mdx": () => import('./intro_DNdD3l-2.mjs'),"/src/content/docs/de/welcome-to-docs.mdx": () => import('./welcome-to-docs_BC_UdwxH.mjs'),"/src/content/docs/es/guides/first-project-checklist.mdx": () => import('./first-project-checklist_yK54OBJr.mjs'),"/src/content/docs/es/guides/getting-started.mdx": () => import('./getting-started_Cxc2s84N.mjs'),"/src/content/docs/es/guides/intro.mdx": () => import('./intro_DUW-K4_W.mjs'),"/src/content/docs/es/welcome-to-docs.mdx": () => import('./welcome-to-docs_DF755wY3.mjs'),"/src/content/docs/fa/guides/first-project-checklist.mdx": () => import('./first-project-checklist_Bb6vsn9F.mjs'),"/src/content/docs/fa/guides/getting-started.mdx": () => import('./getting-started_CMyt-_em.mjs'),"/src/content/docs/fa/guides/intro.mdx": () => import('./intro_CRr0uGMI.mjs'),"/src/content/docs/fa/welcome-to-docs.mdx": () => import('./welcome-to-docs_tFXmT9NS.mjs'),"/src/content/docs/fr/guides/first-project-checklist.mdx": () => import('./first-project-checklist_y4MT4baF.mjs'),"/src/content/docs/fr/guides/getting-started.mdx": () => import('./getting-started_C379SEMR.mjs'),"/src/content/docs/fr/guides/intro.mdx": () => import('./intro_3DPRHPSM.mjs'),"/src/content/docs/fr/welcome-to-docs.mdx": () => import('./welcome-to-docs_BZ_pYdXf.mjs'),"/src/content/docs/guides/first-project-checklist.mdx": () => import('./first-project-checklist_BpZSP0WB.mjs'),"/src/content/docs/guides/getting-started.mdx": () => import('./getting-started_CCmCpH93.mjs'),"/src/content/docs/guides/intro.mdx": () => import('./intro_CEkQ-4ui.mjs'),"/src/content/docs/ja/guides/first-project-checklist.mdx": () => import('./first-project-checklist_BmWxSyIF.mjs'),"/src/content/docs/ja/guides/getting-started.mdx": () => import('./getting-started_BPSl_ZUt.mjs'),"/src/content/docs/ja/guides/intro.mdx": () => import('./intro_B1I8Dq9g.mjs'),"/src/content/docs/ja/welcome-to-docs.mdx": () => import('./welcome-to-docs_DkoabUFg.mjs'),"/src/content/docs/tools/equipment-care.mdx": () => import('./equipment-care_Bm5NGZqx.mjs'),"/src/content/docs/tools/tool-guides.mdx": () => import('./tool-guides_qBCWfsm4.mjs'),"/src/content/docs/welcome-to-docs.mdx": () => import('./welcome-to-docs_D1XaLaqg.mjs'),"/src/content/docs/zh-cn/guides/first-project-checklist.mdx": () => import('./first-project-checklist_r9EkWO0K.mjs'),"/src/content/docs/zh-cn/guides/getting-started.mdx": () => import('./getting-started_BFZtJihh.mjs'),"/src/content/docs/zh-cn/guides/intro.mdx": () => import('./intro_BF0DfPRJ.mjs'),"/src/content/docs/zh-cn/welcome-to-docs.mdx": () => import('./welcome-to-docs_Bxm3gvRo.mjs'),"/src/content/insights/insight-1.md": () => import('./insight-1_BufNVe-b.mjs'),"/src/content/insights/insight-2.md": () => import('./insight-2_Dd5X9Xes.mjs'),"/src/content/insights/insight-3.md": () => import('./insight-3_exAlP6q4.mjs'),"/src/content/products/a765.md": () => import('./a765_BCgksaFq.mjs'),"/src/content/products/b203.md": () => import('./b203_BYTXGiA5.mjs'),"/src/content/products/f303.md": () => import('./f303_Ch0G_30V.mjs'),"/src/content/products/t845.md": () => import('./t845_iroIa0JC.mjs')});
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/blog/post-1.md": () => import('./post-1_ziH1HSmA.mjs'),"/src/content/blog/post-2.md": () => import('./post-2_CmjKJsq7.mjs'),"/src/content/blog/post-3.md": () => import('./post-3_BFb34ZfB.mjs'),"/src/content/docs/advanced/technical-specifications.mdx": () => import('./technical-specifications_D7PO3DBE.mjs'),"/src/content/docs/construction/custom-solutions.mdx": () => import('./custom-solutions_QW8YXhSv.mjs'),"/src/content/docs/construction/project-planning.mdx": () => import('./project-planning_D83Abe6p.mjs'),"/src/content/docs/construction/safety.mdx": () => import('./safety_BZX4PMg0.mjs'),"/src/content/docs/construction/service-overview.mdx": () => import('./service-overview_DKIsnBkw.mjs'),"/src/content/docs/de/guides/first-project-checklist.mdx": () => import('./first-project-checklist_DYha0ufk.mjs'),"/src/content/docs/de/guides/getting-started.mdx": () => import('./getting-started_CYhn5ZwZ.mjs'),"/src/content/docs/de/guides/intro.mdx": () => import('./intro_nsfQt0Iv.mjs'),"/src/content/docs/de/welcome-to-docs.mdx": () => import('./welcome-to-docs_Bs6BTNu_.mjs'),"/src/content/docs/es/guides/first-project-checklist.mdx": () => import('./first-project-checklist_BrGY8KVI.mjs'),"/src/content/docs/es/guides/getting-started.mdx": () => import('./getting-started_9wsKdH2C.mjs'),"/src/content/docs/es/guides/intro.mdx": () => import('./intro_BAnH2_1B.mjs'),"/src/content/docs/es/welcome-to-docs.mdx": () => import('./welcome-to-docs_C9Yuz0mS.mjs'),"/src/content/docs/fa/guides/first-project-checklist.mdx": () => import('./first-project-checklist_CzVCOIR1.mjs'),"/src/content/docs/fa/guides/getting-started.mdx": () => import('./getting-started_C0LZt0sc.mjs'),"/src/content/docs/fa/guides/intro.mdx": () => import('./intro_CMIvUdAo.mjs'),"/src/content/docs/fa/welcome-to-docs.mdx": () => import('./welcome-to-docs_C_Xjw_ye.mjs'),"/src/content/docs/fr/guides/first-project-checklist.mdx": () => import('./first-project-checklist_C6Fo-v3Z.mjs'),"/src/content/docs/fr/guides/getting-started.mdx": () => import('./getting-started_BPA980l1.mjs'),"/src/content/docs/fr/guides/intro.mdx": () => import('./intro_D5G5I9jL.mjs'),"/src/content/docs/fr/welcome-to-docs.mdx": () => import('./welcome-to-docs_CkXY2wtC.mjs'),"/src/content/docs/guides/first-project-checklist.mdx": () => import('./first-project-checklist_BPYukBNs.mjs'),"/src/content/docs/guides/getting-started.mdx": () => import('./getting-started_DLJJd-xB.mjs'),"/src/content/docs/guides/intro.mdx": () => import('./intro_Bo60pgFx.mjs'),"/src/content/docs/ja/guides/first-project-checklist.mdx": () => import('./first-project-checklist_58sb4R0f.mjs'),"/src/content/docs/ja/guides/getting-started.mdx": () => import('./getting-started_DaoiNH7K.mjs'),"/src/content/docs/ja/guides/intro.mdx": () => import('./intro_BYVdcooJ.mjs'),"/src/content/docs/ja/welcome-to-docs.mdx": () => import('./welcome-to-docs_DhLI9HOv.mjs'),"/src/content/docs/tools/equipment-care.mdx": () => import('./equipment-care_DwRzHGDI.mjs'),"/src/content/docs/tools/tool-guides.mdx": () => import('./tool-guides_DXaeYLoh.mjs'),"/src/content/docs/welcome-to-docs.mdx": () => import('./welcome-to-docs_Cp9b0x1I.mjs'),"/src/content/docs/zh-cn/guides/first-project-checklist.mdx": () => import('./first-project-checklist_BhCLBa3E.mjs'),"/src/content/docs/zh-cn/guides/getting-started.mdx": () => import('./getting-started_CK6oqr-G.mjs'),"/src/content/docs/zh-cn/guides/intro.mdx": () => import('./intro_C7cp4Gk6.mjs'),"/src/content/docs/zh-cn/welcome-to-docs.mdx": () => import('./welcome-to-docs_DyEGvjw_.mjs'),"/src/content/insights/insight-1.md": () => import('./insight-1_Djoqaebv.mjs'),"/src/content/insights/insight-2.md": () => import('./insight-2_BOHh8b-4.mjs'),"/src/content/insights/insight-3.md": () => import('./insight-3_DDnpsvb2.mjs'),"/src/content/products/a765.md": () => import('./a765_vyfkn4yM.mjs'),"/src/content/products/b203.md": () => import('./b203_BwspjRiI.mjs'),"/src/content/products/f303.md": () => import('./f303_DVPDXtIW.mjs'),"/src/content/products/t845.md": () => import('./t845_BPlucCUz.mjs')});
...
const featureImage = new Proxy({"src":"/_astro/features-image.BEGIe8fA.avif","width":4375,"height":2369,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/features-image.avif");
							return target[name];
						}
					});
...
const blueprints = new Proxy({"src":"/_astro/blueprints-image.DxAt2gto.avif","width":1333,"height":2000,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/blueprints-image.avif");
							return target[name];
						}
					});
...
const personWorking = new Proxy({"src":"/_astro/person-working.aUGgRiE_.avif","width":1334,"height":2000,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/person-working.avif");
							return target[name];
						}
					});
...
const beforeAfter = new Proxy({"src":"/_astro/before-after.BntBToq6.avif","width":2048,"height":1366,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/before-after.avif");
							return target[name];
						}
					});
...
const constructionWorkers = new Proxy({"src":"/_astro/construction-workers.XhU7Ouf4.avif","width":1920,"height":1280,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/construction-workers.avif");
							return target[name];
						}
					});
...
const aerialView = new Proxy({"src":"/_astro/aerial-view.CeV30CXX.avif","width":1920,"height":1282,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/aerial-view.avif");
							return target[name];
						}
					});
...
const usingTools = new Proxy({"src":"/_astro/using-tools.BrEE8t5H.avif","width":1920,"height":1280,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/using-tools.avif");
							return target[name];
						}
					});
...
const progressBuilding = new Proxy({"src":"/_astro/progress-building.Cjca0suI.avif","width":1920,"height":2560,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/progress-building.avif");
							return target[name];
						}
					});
...
const underConstruction = new Proxy({"src":"/_astro/under-construction.DfISh1yq.avif","width":1920,"height":2876,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/under-construction.avif");
							return target[name];
						}
					});
...
const heroImage = new Proxy({"src":"/_astro/hero-image.DRPoHq2O.avif","width":4067,"height":2576,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/hero-image.avif");
							return target[name];
						}
					});
...
const construction = new Proxy({"src":"/_astro/construction-image.6K-xbeL4.avif","width":1600,"height":2400,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/construction-image.avif");
							return target[name];
						}
					});
...
const tools = new Proxy({"src":"/_astro/automated-tools.NvGNhe84.avif","width":1920,"height":2560,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/automated-tools.avif");
							return target[name];
						}
					});
...
const dashboard = new Proxy({"src":"/_astro/dashboard-image.DUm-YPUR.avif","width":1920,"height":1920,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/dashboard-image.avif");
							return target[name];
						}
					});
...
const maskableIcon = new Proxy({"src":"/_astro/icon-maskable.C1A7b-dw.png","width":1024,"height":1024,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/icon-maskable.png");
							return target[name];
						}
					});
