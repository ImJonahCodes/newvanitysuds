const id = "t845.md";
						...
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/product-image-1.avif");
							return target[name];
						}
					})
					,imgMain:
						...
						get(target, name, receiver) {
							...
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/workspaces/newvanitysuds/src/images/product-image-main-1.avif");
							return target[name];
						}
					})
