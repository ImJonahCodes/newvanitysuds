const id = "ja/guides/getting-started.mdx";
						...
						const data = {title:"入門",description:"ScrewFastの包括的なドキュメントを探索して、プレミアムツールと建設サービスを詳しく見てください。",editUrl:true,head:[],template:"doc",sidebar:{order:1,label:"Getting Started",hidden:false,attrs:{}},pagefind:true};
						const _internal = {
							type: 'content',
							filePath: "/workspaces/newvanitysuds/src/content/docs/ja/guides/getting-started.mdx",
							rawData: undefined,
						};
