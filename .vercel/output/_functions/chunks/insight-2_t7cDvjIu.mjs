const id = "insight-2.md";
					...
					,cardImageAlt:"Top view mechanical tools arrangement"};
						const _internal = {
							type: 'content',
							filePath: "/workspaces/newvanitysuds/src/content/insights/insight-2.md",
							rawData: undefined,
						};
